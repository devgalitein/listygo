...
class GatewayWooPayment extends PaymentGateway {
	...
	public function goto_web_with_check() {
		...
		Api::is_valid_http_auth_request( $request, [ 'rtcl_app_woo_payment' => true ] );
	...
	public function init_form_fields() {
		...
		$this->form_fields      = [
			'woo_section'        => [
				'title' => esc_html__( 'WooCommerce Payment Settings', 'classified-listing' ),
				'type'  => 'section'
			],
			'enabled'            => [
				...
				'description' => __( '<span style="color: red">If <strong>WooCommerce Payment</strong> is enabled you can not use other payments provided by ClassifiedListing.</span>',
			...
			'available_payments' => [
				...
				'description' => __( 'List of all available payment gateways installed and activated for WooCommerce. Click on a payment method to go to <strong>WooCommerce Payment</strong> settings.',
					'classified-listing-pro' ),
			],
		];
	}
