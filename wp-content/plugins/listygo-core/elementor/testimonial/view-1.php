...
if ($data['layout'] == 'grid') {
?>
<div class="row row-cols-lg-<?php echo esc_attr( $data['cols'] ); ?> row-cols-sm-2 row-cols-1 testimonial-layout grid-layout">
        ...
        <div class="swiper-wrapper" data-carousel-options="<?php echo esc_attr( $data['swiper_data'] ); ?>">
            ...
            <div class="swiper-slide">
                ...
                <div class="testimonial-content">
                    ...
                    <div class="poster-info">
                        <h3 class="item-title" data-swiper-parallax-x="-200" data-swiper-parallax-duration="1400"><?php echo wp_kses_stripslashes( $slide['testi_name'] ); ?></h3>
                        <h4 class="item-designation" data-swiper-parallax-x="-250" data-swiper-parallax-duration="1600"><?php echo wp_kses_stripslashes( $slide['testi_desig'] ); ?></h4>
                    </div>
                    <div class="quote-icon">
                        <?php echo Helper::quote_icon(); ?>
                    </div>
                </div>
            </div>
            <?php } ?>
