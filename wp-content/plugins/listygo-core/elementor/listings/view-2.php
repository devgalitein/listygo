...
?>
<div class="rtcl section-1500">
  <div class="row row-cols-xl-<?php echo esc_attr( $cols ); ?> row-cols-lg-1 row-cols-1 <?php echo esc_attr( $gutters ); ?> listing-shortcode listing-list-shortcode rtcl-list-view">
    <?php 
    ...
    <div class="col <?php echo esc_attr( $action_class ); ?>">
      <div class="product-box listygo-rating <?php echo esc_attr( $dclass ); ?>">
        <?php
        // var_dump(has_action('rtcl_before_listing_loop_item'));
          /**
