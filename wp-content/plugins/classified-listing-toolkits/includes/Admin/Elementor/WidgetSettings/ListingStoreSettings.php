	...
	public function general_fields() {
		...
		$fields = [
			...
			[
				...
				'label'     => __( 'Column', 'classified-listing-store' ),
	...
	public function wrapper_style() {
		$fields = [
			[
				...
				'label' => __( 'Item Wrapper', 'classified-listing-store' ),
			],
			[
				'type'      => Controls_Manager::COLOR,
				'id'        => 'rtcl_wrapper_bg_color',
				'label'     => __( 'Background Color', 'classified-listing-store' ),
				'selectors' => [
					'{{WRAPPER}} .rtcl-elementor-widget .store-item' => 'background-color: {{VALUE}};',
				],
			],
			[
				'label'    => __( 'Box Shadow', 'classified-listing-store' ),
			...
			[
				'label'    => __( 'Hover Box Shadow', 'classified-listing-store' ),
				'type'     => Group_Control_Box_Shadow::get_type(),
				'mode'     => 'group',
			...
			[
				'label'      => __( 'Wrapper Spacing', 'classified-listing-store' ),
				'mode'       => 'responsive',
			...
			[
				...
				'label'      => __( 'Gutter Spacing', 'classified-listing-store' ),
				'mode'       => 'responsive',
				'size_units' => [ 'px', '%' ],
				'range'      => [
					'px' => [
			...
			[
				...
				'label'          => __( 'Border', 'classified-listing-store' ),
				'mode'           => 'group',
