...
class BookingApprovedEmailToUser extends RtclEmail {
	...
	public function __construct() {
		$this->db            = true;
		$this->id            = 'booking_approved';
		$this->template_html = 'emails/booking-approved-email-to-user';
	...
	public function get_default_subject() {
		return esc_html__( '[{site_title}] Booking "{listing_title}" is approved', 'rtcl-booking' );
	}
	...
	public function get_default_heading() {
		return esc_html__( 'Your booking is approved', 'rtcl-booking' );
	}
