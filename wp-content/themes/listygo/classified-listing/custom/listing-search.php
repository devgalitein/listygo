...
?>
   ...
   <form action="<?php echo esc_url(Functions::get_filter_form_url()); ?>" class="form-vertical rtcl-widget-search-form rtcl-search-inline-form listygo-listing-search-form rtin-style-<?php echo esc_attr($style[0]); ?>">
      <div class="inner-form-wrap">
            ...
            <div class="btn-wrap">
               <div class="form-group">
                  <div class="rtcl-search-input-button rtin-keyword">
                     <input type="text" id="keyword" data-type="listing" name="q" class="rtcl-autocomplete" placeholder="<?php esc_attr_e('What are you looking for', 'listygo'); ?>" value="<?php if (isset($_GET['q'])) {
         ...
         <?php }
         if ($data['search_location'] == 'on' && isset($search_items['location']) &&  $search_items['location'] == 'location') { ?>
            ...
            <?php } ?>
         <?php }
         if ($data['search_category'] == 'on' && isset($search_items['category']) &&  $search_items['category'] == 'category') { ?>
