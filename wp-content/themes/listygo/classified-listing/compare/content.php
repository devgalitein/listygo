...
if (empty($compare_ids) || !is_array($compare_ids)) {
    ?>
    <p class="rtcl-no-item-found"><?php esc_html_e("No Items Selected", 'listygo'); ?></p>
    <?php
} ?>
    ...
    <table class="rtcl-compare-table">
        ...
        <tr>
            ...
            foreach ($compare_ids as $compare_id) {
                ...
                if ($listing) {
                    $listings[] = $listing;
                    ?>
                    <th class="rtcl-compare-table-head" data-listing_id="<?php echo esc_attr($listing->get_id()); ?>">
                        <div class="rtcl-compare-table-remove">
                            <div class="rtcl-compare-remove" data-listing_id="<?php echo esc_attr($listing->get_id()); ?>">
                        ...
                        <div class="rtcl-compare-table-thumb">
                            <a href="<?php echo get_the_permalink($listing->get_id()) ?>">
                                <div class="rtcl-compare-table-image"
                                     style="background-image:url(<?php echo esc_url($listing->get_the_thumbnail_url('rtcl-gallery')) ?>);"></div>
                            </a>
                        </div>
        ...
        if (!empty($listings)) {
            $labels = [
                ...
                'review'   => esc_html__("Review", 'listygo'),
                'category' => esc_html__("Category", 'listygo')
            ];
                ...
                <tr class="rtcl-compare-table-item" data-item="<?php echo esc_attr($labelKey); ?>">
                    ...
                    <?php foreach ($listings as $listing) { ?>
                        <td class="rtcl-compare-table-value" data-value-item="<?php echo esc_attr($labelKey); ?>"
                            data-listing_id="<?php echo esc_attr($listing->get_id()); ?>">
                            <?php
                            if ("price" === $labelKey) {
                                echo wp_kses_stripslashes($listing->get_price_html());
